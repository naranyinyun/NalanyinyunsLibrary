...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/143414565.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
		position: "top", // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
		credit: {
			enable: true, // Display the credit text of the banner image
			text: "Sea Breeze", // Credit text to be displayed
			url: "https://www.pixiv.net/artworks/143414565", // (Optional) URL link to the original artwork or artist's page
		},
	},
	toc: {
...
export const navBarConfig: NavBarConfig = {
	links: [LinkPreset.Home, LinkPreset.Notes, LinkPreset.About, LinkPreset.LinkExchange],
};
